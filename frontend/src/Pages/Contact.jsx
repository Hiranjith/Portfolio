          ...
          <div className="flex flex-col gap-4 bg-[#0A111D]/40 backdrop-blur-sm border border-[#18283D] p-6 rounded-2xl h-full">
            ...
            <div className="pt-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-[44px] h-[44px] flex items-center justify-center rounded-xl border border-[#18283D] hover:border-[#00D9A5] hover:text-[#00D9A5] transition-colors bg-[#0A111D]/40 text-[#94A3B8]">
                  {/* LinkedIn SVG */}
